...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for JSSON - JavaScript Simplified Object Notation',
};
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              By accessing and using JSSON (the "Service"), you accept and agree to be bound by the
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              JSSON is provided as open-source software under the MIT License. You are free to:
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              In no event shall JSSON or its contributors be liable for any damages (including,
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              The JSSON Playground runs entirely in your browser using WebAssembly. We do not
              collect, store, or transmit any code you write in the playground. All transpilation
