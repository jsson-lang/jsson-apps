...
const features = [
  ...
  },
  {
    ...
    description:
      "Full math, comparisons, modulo, and ternaries right inside the DSL.",
  },
  {
    title: "Nested Structures",
    description:
      "Naturally express deep arrays and multi-level data expansions.",
  },
  {
    title: "Composition",
    description:
      "Break large configs into parts and merge them with clean include rules.",
  },
  {
    title: "Native Types",
    description:
      "Clean syntax for strings, numbers, and booleans without quoting hell.",
  },
];
  ...
  return (
    <section className="py-32 border-t border-border/10">
      <div className="container mx-auto px-6">
        <div className="mb-24">
          <h2 className="text-xs font-black uppercase tracking-[0.4em] text-muted-foreground mb-4">Features</h2>
