  ...
  return (
    <section className="py-32 border-t border-border/10">
      <div className="container mx-auto px-6">
        <div className="mb-24">
          <h2 className="text-xs font-black uppercase tracking-[0.4em] text-muted-foreground mb-4">Evolution & Maintenance</h2>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className={cn("flex flex-col h-full", isFeatured && "lg:flex-row lg:items-stretch lg:gap-12")}>
                    <div className={cn("flex-1", isFeatured && "lg:pr-12 lg:border-r lg:border-border/20 lg:border-dashed")}>
                      <h3 className={cn("font-bold uppercase tracking-tight mb-4 group-hover:text-primary transition-colors", isFeatured ? "text-2xl sm:text-3xl" : "text-xl")}>
                        {release.title}
                      </h3>
                      
                      <p className={cn("text-muted-foreground font-normal leading-relaxed mb-8", isFeatured ? "text-base max-w-2xl" : "text-sm")}>
                        {release.description}
                      </p>
                    </div>
                  ...
                  <div className={cn(
                    ...
                    isFeatured && "lg:mt-0 lg:pt-0 lg:border-t-0 lg:flex-col lg:items-end lg:justify-center lg:gap-6 lg:min-w-[200px]"
                  )}>
                    <div className={cn("flex flex-col items-start gap-1", isFeatured && "lg:items-end")}>
