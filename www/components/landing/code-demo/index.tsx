...
export function CodeDemo() {
  ...
  const [outputFormat, setOutputFormat] = useState<'json' | 'yaml' | 'toml' | 'typescript'>('json');
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-center gap-4 group">
                  ...
                  <span className="text-sm font-black uppercase tracking-widest opacity-80 group-hover:opacity-100 transition-opacity">
                    {item}
                  </span>
                </div>
              ))}
              ...
              <div className="flex flex-col">
                ...
                <div className="p-4 bg-muted/5 relative overflow-hidden">
                  <CodeBlock
                    ...
                    language="json"
                    className="text-xs opacity-80 relative z-10"
                  />
                </div>
              </div>
            </div>
