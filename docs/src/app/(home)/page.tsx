    ...
    <div className="flex flex-col min-h-screen">
      <section className="flex flex-1 flex-col items-center justify-center px-6 py-32 text-center">
        ...
        <p className="mt-8 max-w-xl text-lg text-muted-foreground sm:text-xl font-light tracking-tight">
          Universal configuration format. Write once, output JSON, YAML, TOML, or TypeScript. Learn with docs here.
        </p>
      ...
      <section className="px-6 py-32 border-t border-border/10">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-muted-foreground mb-8">Philosophy</h2>
          <p className="text-3xl sm:text-4xl font-bold tracking-tighter leading-[1.1]">
            Configuration should be expressive, logic-first, and completely type-safe. 
            Stop repeating yourself across formats.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="grid gap-16 sm:grid-cols-3">
            <div className="flex flex-col gap-4">
              <h3 className="text-xs font-black uppercase tracking-[0.4em] text-muted-foreground">01. Universal</h3>
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-xs font-black uppercase tracking-[0.4em] text-muted-foreground">02. Logic-First</h3>
              <p className="text-lg font-medium leading-snug">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-xs font-black uppercase tracking-[0.4em] text-muted-foreground">03. Production Ready</h3>
              <p className="text-lg font-medium leading-snug">
      ...
      <footer className="px-6 py-12 border-t border-border/10">
        <div className="mx-auto flex max-w-4xl items-center justify-between text-[10px] font-bold uppercase tracking-[0.3em] text-muted-foreground">
          <div className="flex gap-8">
            <Link href="https://github.com/jssonlang/jsson" className="hover:text-foreground transition-colors">GitHub</Link>
            <Link href="https://playground.jssonlang.tech" className="hover:text-foreground transition-colors">Playground</Link>
          </div>
