    ...
    <section className="px-6 py-24 sm:py-32 bg-foreground/5">
      <div className="mx-auto max-w-5xl">
        <div className="grid gap-24 lg:grid-cols-2">
          ...
          <div className="space-y-12">
            ...
            <ul className="space-y-6">
              {[
                ...
                <li
                  key={i}
                  className="text-xl font-bold uppercase tracking-tighter border-b border-border/10 pb-4"
                >
                  {feature}
                </li>
              ))}
          ...
          {/* v0.0.6 Teaser */}
          <div className="space-y-12">
            <h2 className="text-2xl font-black uppercase tracking-[0.2em] opacity-40 text-muted-foreground">
              COMING SOON IN v0.0.6
            </h2>
            <div className="space-y-8">
              ...
              <div className="group">
                ...
                <p className="text-muted-foreground font-light uppercase tracking-widest text-xs">
                  Kebab, snake, semver & custom schemas
                </p>
              </div>
